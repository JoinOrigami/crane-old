...
export type { GovernanceTokenFactory } from "./contracts/GovernanceTokenFactory";
export { GovernanceTokenFactory__factory } from "./factories/contracts/GovernanceTokenFactory__factory";
