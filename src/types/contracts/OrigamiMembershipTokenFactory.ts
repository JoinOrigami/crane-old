...
export interface OrigamiMembershipTokenFactoryInterface
  extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "createOrigamiMembershipToken(address,string,string,string)": FunctionFragment;
    "getProxyContractAddress(uint256)": FunctionFragment;
    "getRoleAdmin(bytes32)": FunctionFragment;
    "grantRole(bytes32,address)": FunctionFragment;
    "hasRole(bytes32,address)": FunctionFragment;
    "initialize()": FunctionFragment;
    "proxiedContracts(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "DEFAULT_ADMIN_ROLE"
      | "createOrigamiMembershipToken"
      | "getProxyContractAddress"
      | "getRoleAdmin"
      | "grantRole"
      | "hasRole"
      | "initialize"
  ...
  encodeFunctionData(
    functionFragment: "createOrigamiMembershipToken",
  ...
  encodeFunctionData(
    functionFragment: "proxiedContracts",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface OrigamiMembershipTokenFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrigamiMembershipTokenFactoryInterface;
