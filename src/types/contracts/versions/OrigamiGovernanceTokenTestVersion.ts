...
export interface OrigamiGovernanceTokenTestVersionInterface
...
export interface OrigamiGovernanceTokenTestVersion extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrigamiGovernanceTokenTestVersionInterface;
