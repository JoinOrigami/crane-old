...
export interface OrigamiMembershipTokenBeforeInitialAuditFeedbackInterface
...
export interface OrigamiMembershipTokenBeforeInitialAuditFeedback
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrigamiMembershipTokenBeforeInitialAuditFeedbackInterface;
